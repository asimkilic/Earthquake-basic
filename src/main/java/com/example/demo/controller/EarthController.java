...
import com.example.demo.entity.Earthquake;
...
public class EarthController {
    ...
    public List<Earthquake> getAllData(@PathVariable Long count,@PathVariable("country") String country) throws MalformedURLException {
        ...
        try {
            ...
            System.out.println("HTTP isteği yapılırken bir hata oluştu : " + e.getMessage());
        }
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                try {
                    ...
                    System.out.println("Yer bilgisinde hata var. Hatalı url: " + url);
                }
            ...
            System.out.println("Json sonuçları earthquake nesnesine bind edilirken bir hata oluştu Ex: " + e.getMessage());
        }
        return earthquakes;
    }
    ...
    private String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            System.out.println("Deprem sonuçları alınırken bir hata oluştu:" + e.getMessage());
        } finally {
